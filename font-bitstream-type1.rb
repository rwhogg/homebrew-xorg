class FontBitstreamType1 < Formula
  ...
  mirror "http://xorg.freedesktop.org/archive/individual/font/font-bitstream-type1-1.0.3.tar.bz2"
  mirror "http://ftp.x.org/archive/individual/font/font-bitstream-type1-1.0.3.tar.bz2"
